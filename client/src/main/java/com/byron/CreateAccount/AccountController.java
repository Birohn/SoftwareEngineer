...
//            AnchorPane root = (AnchorPane) loader.load(getClass().getResource("views/Login.fxml").openStream());
            AnchorPane root = FXMLLoader.load(getClass().getClassLoader().getResource("views/Login.fxml"));
